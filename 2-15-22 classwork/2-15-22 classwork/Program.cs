...
namespace _2_15_22_classwork
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine($"Count: {myList.Count}, capacity: {myList.Capacity}");  // .Size and .Capacity properties were created in the MyArrayList class below
    ...
    class MyArrayList<T> : IEnumerable  // <T> is for any data type; IEnumerable is for our GetEnumerator() constructor
    {
        ...
        public int Count { get; private set; }  // Number of elements in the array
        ...
        public void Insert(T newValue, int position)  // add an element anywhere in the array
        {
            ...
            if (position > Count) 
                throw new Exception($"You can't leave gaps between elements; position argument should be at most {Count}.");
            ...
            for (int i = Count-1; i >= position; i--)  // working from right to left in the array (Count-1 is the last element position in the array)
        ...
        public bool IsEmpty()
        {
            ...
            return Count == 0;  // will return true or false
        }
